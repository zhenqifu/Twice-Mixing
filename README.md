...
Download the pretrained model [pre-trained model (baidu)](https://pan.baidu.com/s/1ClGBtwXZzGrcLiwGf-IdfA)(qacp).
...
To train the model, you need to first prepare our [dataset (baidu)](https://pan.baidu.com/s/10pSRRu9OyeaVh2ZlSh4BlA)(lstd). 
